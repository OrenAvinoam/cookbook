      ...
      {steps.map((step, i) => {
        ...
        return (
          ...
          >
            ...
            {isOpen && (
              <div style={{ padding: "12px 16px 16px 56px", fontSize: "13px", color: t.inkLight, fontFamily: sans, lineHeight: 1.75, borderTop: `1px solid ${t.border}`, animation: "fadeSlideIn 0.18s ease" }}>
                {step.body}
              </div>
            )}
          </div>
